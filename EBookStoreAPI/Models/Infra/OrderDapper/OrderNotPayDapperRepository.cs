...
{
    public class OrderNotPayDapperRepository
    {
        private readonly EbookStoreDepperContext _connStr;
        public OrderNotPayDapperRepository(EbookStoreDepperContext context)
        {
            _connStr = context;
        }


        public IEnumerable<OrdersVM> OrderItemLoad(GetOrdersListId dto)
        {
